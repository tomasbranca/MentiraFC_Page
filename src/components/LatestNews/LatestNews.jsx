...
const LatestNews = ({ news }) => {
  ...
  return (
    <section className="latest-news bg-violet-900 text-violet-50">
      ...
      <div className="flex justify-between items-center mb-6 mt-10 px-6 py-6 border-t-4 border-violet-500">
        <h2 className="text-2xl font-bold uppercase">Más noticias</h2>
