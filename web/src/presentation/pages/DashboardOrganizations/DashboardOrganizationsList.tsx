  ...
  return (
    <div>
      <DashboardPageHeader
        ...
        description="Administra marcas, logos y colores que usan los torneos oficiales."
        actions={
      ...
      {totalOrganizations === 0 ? (
        <DashboardEmptyState message="Todavia no hay organizadores ni borradores cargados." />
      ) : (
        <>
