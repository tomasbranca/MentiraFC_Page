...
const DashboardPlayersForm = () => {
  ...
  const handleSaveDraft = async () => {
    ...
    if (photoError || nextRatingError) {
      setStatus("No se pudo guardar el integrante porque la ficha tiene errores.");
      return;
    }
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    if (
      ...
      setStatus("No se pudo guardar el integrante porque faltan datos obligatorios.");
      return;
    }
      ...
      <div className="grid gap-4 p-3 sm:gap-5 sm:p-6 lg:grid-cols-[minmax(0,1fr)_20rem]">
        ...
        >
          ...
          <DashboardFormActions
            ...
            cancelTo={ROUTES.DASHBOARD_PLAYERS}
            error={status}
          />
        </form>
