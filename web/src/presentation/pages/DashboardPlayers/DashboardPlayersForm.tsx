...
const DashboardPlayersForm = () => {
  ...
  if (playerQuery.isError) {
    return (
      <ErrorFallback
        title="No pudimos cargar el jugador"
  ...
  const handleRemovePhoto = async () => {
    ...
    const confirmed = await confirmDashboardAction({
      title: "Quitar foto",
      text: "La ficha del jugador va a quedar sin foto al guardar.",
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const confirmed = await confirmDashboardAction({
      title: isEditing ? "Publicar cambios" : "Publicar jugador",
      text: isEditing
        ? "El borrador se va a publicar en Sanity y actualizara la ficha visible en el sitio."
        : "El jugador se va a publicar en Sanity y quedara visible en el sitio.",
    ...
    try {
        ...
        ),
        {
          loading: selectedPhotoFile
            ...
            : isEditing
              ...
              : "Publicando jugador en Sanity...",
          success: isEditing
            ? "Cambios publicados correctamente."
            : "Jugador publicado correctamente.",
          error: "No pudimos publicar el jugador.",
        },
        saveToastOptions
      );
    } catch (error) {
      ...
      setStatus("No pudimos publicar el jugador. Intenta de nuevo.");
    }
  };
